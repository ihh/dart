...
typedef double Real;
// "long double" replaced with "double" by ihh, 7/19/2004, since OS X's gcc was complaining
// "long double" restored by ihh, 12/15/2008, at suggestion of Peter Schattner, to fix precision problems...
