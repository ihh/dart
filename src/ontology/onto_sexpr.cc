...
void Terminatrix_builder::init_terminatrix (Terminatrix& term, SExpr& sexpr)
{
  ...
  if (term.init_sexpr.has_tag())
    (void) SExpr_Scheme_evaluator::evaluate_values (term.init_sexpr);
  ...
  if (term.model_sexpr.has_tag())
    {
      ...
      model_sexpr = SExpr_Scheme_evaluator::evaluate_sexpr (term.model_sexpr.value());
...
{
  SCM tree_db_list_scm = SExpr_Scheme_evaluator::evaluate_SCM (terminatrix.tree_db_sexpr.value());
...
void Terminatrix_EM_visitor::initialize_current_colmat()
{
  ...
  SCM knowledge_function_scm = SExpr_Scheme_evaluator::evaluate_SCM (terminatrix.knowledge_sexpr.value());
