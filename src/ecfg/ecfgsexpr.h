...
struct ECFG_builder : ECFG_enum, PFunc_builder
{
  ...
  static void expand_macros (SExpr& grammars_sexpr, const Alphabet* alph = 0, const Tree_alignment_database* align_db = 0, const Stockholm_database* stock_db = 0);
  ...
  static void init_chain (ECFG_matrix_set& ems, const Alphabet_dictionary& alph_by_name, const Alphabet& default_alphabet, SymIndex& term2chain, const SymPVar& sym2pvar, SExpr& chain_sexpr, double tres = DEFAULT_TIMEPOINT_RES, bool allow_multi_char_tokens = false);
